...
//    self.view.backgroundColor = [UIColor colorWithRed:32.0/255.0f green:81.0/255.0f blue:112.0/255.0f alpha:1.0];
    ...
    scrollView.contentSize = CGSizeMake(320, 494);
...
//    if ([[[NSUserDefaults standardUserDefaults] objectForKey:@"accessToken"] length]) {
//        
...
//        
//        fbGraph.accessToken = [[NSUserDefaults standardUserDefaults] objectForKey:@"accessToken"];
//        fbGraph.flag=1;
//        
...
//        
//        NSURL *url = [NSURL URLWithString:[[[items valueForKey:@"picture"] valueForKey:@"data"] valueForKey:@"url"]];
//        NSData *data = [NSData dataWithContentsOfURL:url];
//        
//        
//        [[NSUserDefaults standardUserDefaults] removeObjectForKey:@"City_Short_Name"];
...
//    [self LogoutFaceBook];
    ...
    if (appDelegateobj.LoginFlag==FALSE) {
        ...
        // LoginBtn.frame = CGRectMake(115, 423, 89, 34);
...
//        uuidString = [[UIDevice currentDevice].identifierForVendor.UUIDString retain];
//    } else {
//        // This is will run before iOS6 and you can use openUDID or other
//        // method to generate an identifier
//        
//        uuidString = [[currentDevice uniqueIdentifier] retain];
//    }
...
- (void)requestFinished:(ASIHTTPRequest *)request {
    ...
    if (flag==0) {
        //homeObj = [[HomeVIew alloc] initWithNibName:@"HomeVIew" bundle:nil];
        homeObj = [[WhatsGoingViewController alloc] initWithNibName:@"WhatsGoingViewController" bundle:nil];
...
-(IBAction)BackBtnCall {
    ...
    //[appDelegateobj.navController1 popToViewController:[appDelegateobj.navController1.viewControllers objectAtIndex:0] animated:YES];
...
//-(void) animateTextField: (BOOL) up:(int)md {
//    
