...
//    aboutObj = [[About_Us alloc] initWithNibName:@"About_Us" bundle:nil];
...
//    ChangePassword *PasswordObj = [[ChangePassword alloc] initWithNibName:@"ChangePassword" bundle:nil];
...
- (void)viewDidLoad
{
    ...
    [self.SoundTable setSeparatorColor:[UIColor whiteColor]];
...
-(void)viewDidAppear:(BOOL)animated {
    ...
    scroller.contentSize=CGSizeMake(320,965);
}
...
- (void)requestFinished:(ASIHTTPRequest *)request {
    ...
    if (flag==0) {
        ...
        [[NSUserDefaults standardUserDefaults] removeObjectForKey:@"following_count"];
        [[NSUserDefaults standardUserDefaults] removeObjectForKey:@"follower_count"];
        [[NSUserDefaults standardUserDefaults] removeObjectForKey:@"review_count"];
